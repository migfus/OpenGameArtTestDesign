        ...
        <div>
            ...
            <input
                ...
                :class="[
                    ...
                    'w-full rounded-xl border border-brand-900 placeholder-gray-400 focus:border-brand-500 focus:outline-none focus:ring-brand-500 h-8 py-4 px-3 text-brand-800 font-semibold'
                ]"
                autocomplete="off"
            />
